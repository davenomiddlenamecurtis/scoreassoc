...
void usage()
{
	printf("lrBurdenAssoc --gendatafile file || --gcdatafile file     [options]\n\nOptions:\n"
...
int read_ps_datafile(par_info *pi, lrba_par_info *spi, subject **sub, int *nsubptr, char names[MAX_LOCI][20], char comments[MAX_LOCI][MAX_COMMENT_LENGTH], float func_weight[MAX_LOCI],
