...
pathwayAssoc: pathwayAssoc.o dcdflib.o ipmpar.o dcerror.o salrtests.o lrModel.o 
	$(CC) ${DEBUGFLAG} -o pathwayAssoc pathwayAssoc.o dcdflib.o ipmpar.o dcerror.o salrtests.o lrModel.o -lm
