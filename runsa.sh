...
scoreassoc –psdatafile ${GENE}.dat --annotfile ${GENE}.annot --weightfile funcWeights.txt --filterfile exclusions.txt --outfile ${GENE}.psao --minweight 80 --ldthreshold 0.7 --dorecessive
